...
try
	...
	String qry =" select  * from useraccount where Status='"+s+"'"; 
	...
	String id1=rs.getString("id");%>
	  <tbody>
	     <tr > 
            ...
            <td> <%=rs.getString("panid")%> </td>
            <td> <%=rs.getString("aadar")%> </td> 
  			<td> <a href="acc_create.jsp?id=<%=id1%>">Send for Account</a></td>
