...
<script type="text/javascript" src="js/easing.js"></script>    <link href="css/style_b.css" rel='stylesheet' type='text/css' /><!-- BackButton css -->
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					    <ul class="nav navbar-nav">
								 ...
								 <li class="active"><a class="active" href="D_broker.jsp">INTERAGENTS</a></li>
								...
								<li><a href="D_withdrawl.jsp">VIEW WITHDRAWL</a></li> 
	...
	String id1=rs.getString("id");%>
	  <tbody>
	     <tr > 
            ...
            <td><a href="broker_active.jsp?id=<%=id1%>&&email1=<%=rs.getString("email")%>" style="color:green;font-weight:bold;text-decoration:underline;font-size:20px;"><%=rs.getString("status") %></a> </td>
          </tr>
