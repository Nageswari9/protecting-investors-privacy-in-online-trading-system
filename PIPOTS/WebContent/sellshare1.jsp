...
/* int id=0; */
String rr = "pending";
String id1=null,investor=null,tamount=null,email11=null,cname=null;
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					    <ul class="nav navbar-nav">
								  ...
								  <li><a class="active" href="account_creation.jsp">CREATE ACCOUNT</a></li> 
								 <!-- <li class="dropdown">
								...
								<li class="active"><a href="I_vieworders.jsp">VIEW ORDERS</a></li> 
			   ...
			   <div class="w3l-sub-head">
                       <h2 class="tittle">ORDERED SHARES</h2>
               </div>			
		</div>
...
<!-- 			<button class="button1" name="button" value="OK" type="button" onclick="history.back()"><span>BACK</span></button>
 -->				<h6 style="margin-left:330px;font-weight:bold;">Sell Share</h6>
				<div class="col-md-6 w3_agile_news_market" style="border:2px solid black;margin-left:100px;">
				<form name="f" action="sell_sharedb.jsp" method="POST" onsubmit="return validation();" >          
		...
		<td><input type="text" name="name" value="<%=investor%>" placeholder="Username" style="border-radius:5px;width:200px;height:30px;color:black;border:2px solid black;font-size:20px;" readonly></td>
		</tr>
	
		<tr><td><font size="4" color="black"><b>Share Price</b></font></td> 
		<td><input type="text" name="price" placeholder="Share Price" style="border-radius:5px;width:200px;height:30px;color:black;border:2px solid black;font-size:20px;"></td>
		</tr>
		<tr><td><font size="4" color="black"><b>Company</b></font></td> 
		<td><input type="text" name="company" placeholder="Company" readonly value="<%=cname%>" style="border-radius:5px;width:200px;height:30px;color:black;border:2px solid black;font-size:20px;"></td>
		</tr>
		<tr><td><font size="4" color="black"><b>Email</b></font></td> 
		<td><input type="text" name="email" value="<%=email11%>" readonly placeholder="Share Price" style="border-radius:5px;width:200px;height:30px;color:black;border:2px solid black;font-size:20px;"></td>
		</tr>
	    </table>
		<input type="submit" value="Submit" name="submit" style="margin-left:250px;background-color:black;color:white;font-size:20px;margin-top:20px;"><br></br>
				...
				<!-- </div>
				<div class="col-md-3 w3_agile_news_market_left" style="margin-left:150PX;">
						<img src="images/share1.png" width="200" height="250">
				</div> -->
