...
ResultSet rs = null;
	...
	try
	{
       ...
       ps = con.prepareStatement("insert into broker(uname,password,email,mobile,place,state,cname,status) values(?,?,?,?,?,?,?,?)");
		ps.setString(1,a); 
        ps.setString(2,d);
        ps.setString(3,f);
        ps.setString(4,h);
        ...
        ps.executeUpdate();%>
 <script>
 alert("Register Successfully and check your mail for activate account");
