			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					   <ul class="nav navbar-nav">
								...
								<li class="active"><a href="I_viewshares.jsp">ORDER SHARES</a></li> 
...
try
	...
	String qry =" select  * from share_upload"; 
	...
	String id1=rs.getString("id");%>
	  <tbody>
	     <tr> 
            <td> <%=rs.getString("enc_name")%> </td>
             <td> <%=rs.getString("enc_email")%> </td>
            <td> <%=rs.getString("company_name")%> </td>   
         <td> <%=rs.getString("share_price")%> </td>
            <td><a href="choose_broker.jsp?id=<%=id1%>&&cname=<%=rs.getString("company_name")%>&&sname=<%=rs.getString("name")%>&&shareamount=<%=rs.getString("share_price")%>" style="color:#f53753;font-weight:bold;text-decoration:underline;font-size:20px;">CHOOSE SHARE</a> </td>
          </tr>
