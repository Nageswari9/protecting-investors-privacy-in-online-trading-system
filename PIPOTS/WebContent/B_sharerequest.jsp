			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					    <ul class="nav navbar-nav">
          							  <li><a href="B_sharerequest.jsp">Home</a></li>
           							
								<li class="active"><a href="B_sharerequest.jsp">SHARE REQUEST</a></li> 
								  <li ><a class="active" href="B_account.jsp">ACCOUNT CREATION</a></li> 
								 <!-- <li class="dropdown">
...
try
	...
	String qry =" select  * from buy_share where company='"+company+"'"; 
	...
	%>
	  <tbody>
         ...
         <td><a href="confirm_order.jsp?id=<%=id1%>&&shareid=<%=rs.getString("shareid")%>&&iiname=<%=rs.getString("iemail")%>&&iid=<%=rs.getString("iid")%>" style="color:green;font-weight:bold;text-decoration:underline;font-size:20px;">Confirm/Cancel Order</a> </td>
          <td><a href="confirm_order1.jsp?id=<%=id1%>&&shareid=<%=rs.getString("shareid")%>&&iiname=<%=rs.getString("iemail")%>&&iid=<%=rs.getString("iid")%>" style="color:green;font-weight:bold;text-decoration:underline;font-size:20px;">Send To Stock Exchange</a> </td>
          </tr>
	<%	
	}
}
