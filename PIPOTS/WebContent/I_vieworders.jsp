...
try
	...
	String qry ="select  * from buy_share where iid='"+iid+"'"; 
	...
	%>
	  <tbody>
       ...
       <td> <a href="add_payment.jsp?byid=<%=rs.getString("id")%>">Add to Payment</a></td>
       <td><a href="sellshare.jsp?buyid=<%=rs.getString("id")%>">Sell Share</a></td>
        </tr>
	 <%	
	}
}
